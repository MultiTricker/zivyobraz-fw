...
// #define BOARD_TYPE FASANI_EPDIY_V7 // LáskaKit EPDIY V7, basically the same hardware as SVERIO_PAPERBOARD_EPDIY
...
#include "utils.h"
  ...
  #define BT_FASANI_EPDIY_V7 15
  #define BT_SEEEDSTUDIO_XIAO_ESP32C3 16
  #define BT_SEEEDSTUDIO_XIAO_EDDB_ESP32S3 17
...
static constexpr const char BOARD_TYPE_STRING[] = XSTR(BOARD_TYPE);
  ...
  #elif BOARD_ID == BT_FASANI_EPDIY_V7
    #define SVERIO_PAPERBOARD_EPDIY
