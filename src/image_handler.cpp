...
static uint8_t mapColorValue8bit(uint8_t pixelColor)
{
  switch (pixelColor)
  {
    case 0x0: return 0xFF; // White
    case 0x1: return 0x00; // Black
    case 0x2: return 0xEE; // Light grey 1  (was 0xEE)
    case 0x3: return 0xDD; // Dark grey 1   (was 0xBB)
    case 0x4: return 0xEE; // Light grey 2  (was 0xDD)
    case 0x5: return 0xDD; // Light grey 3  (was 0xCC)
    case 0x6: return 0xBB; // Dark grey 2   (was 0x99)
    case 0x7: return 0x88; // Dark grey 3   (was 0x55)
    default:  return 0xFF; // White
  }
}
#endif
