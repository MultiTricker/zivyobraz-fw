...
///////////////////////
  ...
  #define DT_WS75BWT7 10
  #define DT_GDEW075T7BW 11
  #define DT_GDEY075T7BW 12
  #define DT_GDEM102T91 13
  #define DT_GDEM1085T51 14
  #define DT_GDEM133T91 15
  // Grayscale displays
  #define DT_GDEY0154D67 16
  #define DT_GDEY0213B74 17
  #define DT_GDEW042T2_G 18
  #define DT_GDEY042T81 19
  #define DT_GDEQ0426T82 20
  #define DT_GDEW075T7 21
  #define DT_GDEY075T7 22
  // 3C displays
  #define DT_GDEY0154Z90 23
  #define DT_WS27RBW264176 24
  #define DT_WS42YBW400300 25
  #define DT_GDEQ042Z21 26
  #define DT_GDEY042Z98 27
  ...
  // 4C displays
  #define DT_GDEM0154F51H 38
  #define DT_GDEY0213F51 39
  #define DT_GDEY0266F51H 40
  #define DT_GDEY029F51H 41
  #define DT_WS3004YRBW 42
  #define DT_GDEM035F51 43
  #define DT_GDEM0397F81 44
  #define DT_GDEY0420F51 45
  #define DT_GDEM042F52 46
  #define DT_WS437YRBW 47
  #define DT_GDEY0579F51 48
  #define DT_GDEY0583F41 49
  #define DT_GDEM075F52 50
  #define DT_GDEM102F91 51
  #define DT_GDEY116F51 52
  #define DT_GDEY116F91 53
  // 7C displays
  #define DT_GDEP0565D90 54
  #define DT_GDEY073D46 55
  #define DT_GDEP073E01 56
